...
(defhydra ymacs-hydra/emms
    (:color pink
     ...
     (unless (and (fboundp 'emms-playlist-current-selected-track)
       ...
       (emms-play-playlist (ivy-read "Playlist: " ymacs-emms-playlist-list))))
  "
%s(ymacs-emms//current-name)
...
"
  ...
  ("SPC" (emms-play-playlist
          (ivy-read "Playlist: " ymacs-emms-playlist-list)))
