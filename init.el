...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(company-scrollbar-bg ((t (:background "#262626"))))
 '(company-scrollbar-fg ((t (:background "#191919"))))
 '(company-tooltip ((t (:inherit default :background "#0c0c0c"))))
 '(company-tooltip-common ((t (:inherit font-lock-constant-face))))
 '(company-tooltip-selection ((t (:inherit font-lock-keyword-face :background "#333333"))))
